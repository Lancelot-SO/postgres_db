...
> Using PostgreSQL SQL commands for tasks such as creating a database and table, inserting data into the table, and executing various queries with different parameters.
...
```sh
  git clone git@github.com:Lancelot-SO/postgres_db.git
  cd postgres_db
```
...
> Animal tables and queries to be Added
...
Feel free to check the [issues page](https://github.com/Lancelot-SO/postgres_db/issues).
...
I would like to thank microverse community for the support and guidance, also my family for the support.
